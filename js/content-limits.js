...
const ContentLimitHandlers = {
    ...
    init() {
        ...
        if (headerTitle) {
            if (scheduleId) {
                ...
                // Normal context
                headerTitle.textContent = `${childName}'s App & Content Limits`;
            }
        }
    ...
    openCategory(categoryId) {
        ...
        let targetUrl = `category-details.html?category=${categoryId}&child=${encodeURIComponent(childName)}`;
        if (scheduleId) {
